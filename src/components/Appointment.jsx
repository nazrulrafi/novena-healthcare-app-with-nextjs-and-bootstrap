                    ...
                    <div className="col-lg-6 ">
                        <div className="appoinment-content">
                            ...
                            <div className="emergency">
                                <h2 className="text-lg"><i className="icofont-phone-circle text-lg"></i>+23 345 67980
                                </h2>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-10 ">
                        <div className="appoinment-wrap mt-5 mt-lg-0">
                            ...
                            <form id="#" className="appoinment-form" method="post" action="#">
                                ...
                                <a className="btn btn-main btn-round-full" href="appoinment.html">Make Appoinment <i
